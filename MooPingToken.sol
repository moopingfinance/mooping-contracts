...
// MooPingToken with Governance.
contract MooPingToken is BEP20("MooPing Token", "MOOPING") {
    // Max supply: 100,000,000 MOOPING.
        ...
        if (maxTransferAmount() > 0) {
            if (
                ...
                require(
                    ...
                    "MOOPING::antiWhale: Transfer amount exceeds the maxTransferAmount"
                );
                require(
                    swapEnabled == true,
                    "MOOPING::swap: Cannot transfer at the moment"
                );
            }
        }
        _;
    ...
    /**
     * @notice Constructs the MooPingToken contract.
     */
    ...
    /// @dev overrides transfer function to meet tokenomics of MOOPING
    function _transfer(
        address sender,
        address recipient,
        uint256 amount
        ...
        // swap and liquify
        // default tax is 0.2% of every transfer
        uint256 taxAmount = amount.mul(transferTaxRate).div(10000);

        // default 99.8% of transfer sent to recipient
        ...
        onlyOperator
    {
        require(
            ...
            "MOOPING::updateTransferTaxRate: Transfer tax rate must not exceed the maximum rate."
        );
        ...
        onlyOperator
    {
        require(
            ...
            "MOOPING::updateMaxTransferAmountRate: Max transfer amount rate must not exceed the maximum rate."
        );
    ...
    function transferOperator(address newOperator) public onlyOperator {
        require(
            ...
            "MOOPING::transferOperator: new operator is the zero address"
        );
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "MOOPING::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "MOOPING::delegateBySig: invalid nonce"
        );
        require(now <= expiry, "MOOPING::delegateBySig: signature expired");
        ...
        returns (uint256)
    {
        require(
            ...
            "MOOPING::getPriorVotes: not yet determined"
        );
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying MOOPINGs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "MOOPING::_writeCheckpoint: block number exceeds 32 bits"
        );
